  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-4xl space-y-8">
        <div className="relative overflow-hidden rounded-2xl border border-[var(--muted)] bg-gradient-to-b from-white/80 to-white/55 p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
