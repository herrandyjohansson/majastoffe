...
export function Hero() {
  return (
    <>
            ...
            <div className="flex w-full flex-1 flex-col rounded-2xl border border-white/20 bg-black/20 px-5 py-7 text-center shadow-[0_24px_80px_rgba(0,0,0,0.38)] backdrop-blur-[2px] sm:rounded-3xl sm:px-9 sm:py-10">
              <div className="flex flex-1 flex-col items-center justify-center">
                ...
                <h1 className="wedding-name-stack wedding-name-stack--display wedding-name-stack--hero mt-5 text-white sm:mt-6">
                  ...
                  <span className="wedding-name-amp wedding-name-amp--hero" aria-hidden="true">
                    &amp;
                  </span>
                ...
                <div className="mt-5 grid w-full max-w-xl gap-2 sm:grid-cols-2 flex justify-center items-center">
      ...
      <div className="mx-auto mt-7 max-w-6xl px-6 lg:px-8 mb-8">
        <section className="lux-section fade-in-up px-6 py-20 lg:px-10">
          <div className="mb-12 text-center">

            <div className="flex justify-center" aria-hidden="true">
              <span className="wedding-name-heart-wrap">
                <Heart className="wedding-name-heart" />
              </span>
            </div>
